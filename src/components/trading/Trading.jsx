...
import { buyStock, getStocks } from "../../services/equityServices.jsx";
...
export const Trading = ({ currentUser }) => {
  ...
  const handleBuy = (stockId) => {
    ...
    console.log("Buy: Ticker Symbol:", tickerSymbol);
    console.log("Buy: Number of Shares:", numberOfShares);
  ...
  const handleSell = () => {
    console.log("Sell: Ticker Symbol:", tickerSymbol);
    console.log("Sell: Number of Shares:", numberOfShares);
    // Reset form fields
    setTickerSymbol("");
    setNumberOfShares("");
  };
        ...
        <Row>
          <Col>
                        ...
                        return (
                          <>
                            ...
                            <Card.Text>
                              ...
                              <Positions clientId={selectedClient} />
                            </Card.Text>
                          </>
                        );
                      }
            ...
            <Form>
              ...
              <Button variant="success" onClick={() => handleBuy(tickerSymbol)}>
                Buy
              </Button>
...
export const Trading = ({ currentUser }) => {
  ...
  const handleSell = () => {
    ...
    setNumberOfShares("");
    setTickerSymbol(""); // Reset tickerSymbol after sell
  };
